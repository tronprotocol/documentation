...
- **IMPORTANT**: tokenId = 0 (Only in this function) is preserved here, which is presented TRX. This is a experimental feature, we don't recommend to use this logic to transfer trx at least for now.
