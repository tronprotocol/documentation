...
一定时间内，整个网络能够处理的Bandwidth为确定值。对于TRON网络来说，一天的Bandwidth总量约为54GB = 2000000 * 24 * 1200。
一个账户的Bandwidth Points与TRON网络的总Bandwidth的比值等于该账户的冻结资金与TRON网络总冻结资金的比值。
例如，假设当前网络中总冻结资金为100亿TRX，一个账户冻结了10_000TRX，占总冻结资金的百万分之一，则该账户的Bandwidth Points为57600，每天可以执行约300条交易。
...
创建账户将消耗额外的1000 Bandwidth Points，由交易发起者支付。
